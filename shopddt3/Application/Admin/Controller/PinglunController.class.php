...
class PinglunController extends BaseController {
    ...
    public function index(){
        ...
        $arr = $this->pinglun->search_list($this->shop_id,$data,$order_by,$class);
        $goodsclass = D('goodsclass')->getTree(0,true,$this->shop_id);
