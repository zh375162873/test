...
//			$state = $_GET['state'];
	...
	public function auto_login(){
		$wx_mine = I('get.wx_mine',0,'intval');
		if($wx_mine){
			$wx_backurl = 'http://shop.ddt123.cn/index.php/User/mine';
			session('wx_backurl',$wx_backurl);
		}else{
			$wx_backurl = $_SERVER['HTTP_REFERER'];
			session('wx_backurl',$wx_backurl);
		}
	...
	public function auto_shop_login($openid){
		...
		$redirect_uri = session('wx_backurl');
